...
저는 지금 토론토 대학에서도 C 언어를 사용해 파일 시스템을 만들때 필요 요구사항을 읽고 질문하고 이해하며 프로그램을 만들고 있습니다.

\bigskip

들거가기전 OS 프로그램을 구현하기위해 필요한 C 언어 지식을 \texttt{K.N King's C programming}에 있는 문재를 풀고 배우며
