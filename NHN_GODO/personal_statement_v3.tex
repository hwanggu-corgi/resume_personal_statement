...
저는 SiteMax System에서 일하면서
저녁에 Team Treehouse에서 공부했고 Django 기반 Full Stack Development를
...
저는 토론토 대학에서 C 언어와 shell scripting을 함께 이용해 FUSE API 파일 시스템을 무 에서 유로 만들때 안정적으로
구축하고자 필요한 큰 아이디어를 proposal에 썼고 아이디어가 요구사항에 완벽하진 않지만 가까스럽게 맞았을때 실행으로 옮겼습니다.
