...
저는 2년동안 회사에서 300 개 넘는 작은 앱을 요구사항에 맞추어 구현한 경험이 있는 개발자 입니다. (need to come back later)
...
저는 지금 토론토 대학에서도 C 언어를 사용해 file system을 만들때 필요 문구사항을 읽고 모르면 물어보며 요구사항에 맞추어 프로그램을 만들고 있습니다.
OS 프로그램을 구현하기위해 필요한 C 언어 지식을 \texttt{K.N King's C programming}에 있는 문재를 풀고 배우며
지금 코스를 듣으며 공부하고 있습니다.
