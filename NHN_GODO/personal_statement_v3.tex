...
전 이때 큰 앱을 만들며 TDD 기존에 잘 동작된것들이 잘 동작이 안되는것을 많이 부딧히고 하나 고치면 다른것을 고쳐야해서 TDD의 필요함을 얻었고.
...
토론토 대학에서 C 언어와 shell scripting을 함께 이용해 FUSE기반
 파일시스템에 필요한 큰 아이디어를 proposal에 썼고 그리고 큰
