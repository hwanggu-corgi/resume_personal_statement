...
그리고 다 만들었을때 저는 동료들과 코드 리뷰하며 부족한 점이 없는지 요구사항이 다 충족되었는지 논의 하였고 필요성에 따라 앱을 개선했었습니다.
\bigskip

저는 지금 토론토 대학에서도 C 언어를 사용해 파일 시스템을 구축할때 필요 요구사항을 읽고 질문하고 이해하며 프로그램을 만들고 있습니다.
