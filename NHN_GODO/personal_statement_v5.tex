...
하지만 새로운 앱을 하나하나 만들면서 technical requirement를 이해못해 기존에 만들었던 앱들을 계속 수정 해야했고 쌓아져만 가는 일에 선배님에게 혼나기도 했었습니다.
이때 제 선배님의 조언을 들었습니다 "형모야. 일을 한번하면은 되돌아 오지 않게 않는게 핵심이란다" 였습니다.
그 이후 전 일을 하나하나씩 끝내고 선후배와 함께 코드리뷰를 했고 제 자신의 주장을 말하는 것보다 경청을 했고 생각이 다르면 존중히 논의했고 부족하면 보고 배우며 요구사항이 맞을때 까지 계속 수정을 했습니다.
그 결과 전 제 동료하고 하나하나 끝내며 함께 300개 넘는 앱을 만들 수 있었습니다.
제게 기회를 주시면 2 년의 경험과 한번하면 되돌아 오지 않는 끈기로 팀과 함께 일하며 회사의 발전에 기여하겠습니다. 감사합니다.
