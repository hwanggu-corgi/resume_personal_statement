...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 그중에서 가장 기억나는것이 제 선배가 말씀 "형모야. 일을 한번하면은 되돌아 오지 않게 않는게 핵심이란다" 입니다.
        \item 저는 그 이후 후배와 함꼐 일하고 코드리뷰 하면서 성과욕심을 내리고 일을 한번하면 되돌아 오지 않는 제품을 만드는데 주력했습니다.
        \item 동료하고 덕담을 주고받고
        \item 그리고 저는 선배의 말씀을 갖고 Team Treehouse Development
        \item 지금 한층 더 나아가
