...
누구나 solution 을 만들 수 있습니다. 개발을 할때 Solution이 한번하면 되돌아 오지 않고 나중에 다른 맴버에게 피해 주지 않는게 함깨일해요의 핵심입니다.
...
하지만 5 개의 함수나 앱 만들면 기존에 했던 앱들 수정을 계속 해야했고 쌓아져만 가는 일에 선배님에게 많이 혼나기도 했었습니다.
이때 제 선배님의 조언을 들었습니다 "형모야. 일을 한번하면은 되돌아 오지 않게 않는게 핵심이란다" 였습니다.
그 이후 선후배와 함꼐 일하고 코드리뷰 하면서 성과 생각을 내리고 일을 한번하면 되돌아 오지 않는 제품을 만드는데 주력했습니다.
그 결과 전 제 동료하고 함께 앱을 300개 넘는 앱을 만들 수 있었습니다.
