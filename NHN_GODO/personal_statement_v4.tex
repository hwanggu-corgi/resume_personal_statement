...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 5 개를 만들고 새로운 5개를 만들면 수정을 더해 총 10개를 했어야 했습니다
        \item 선배의 꾸지람도 많이 들었습니다
        \item 일을 하며 제 선배가 말씀 해주셨습니다 "형모야. 일을 한번하면은 되돌아 오지 않게 않는게 핵심이란다"
        \item 제 부족함을 경청하고 작게 논의하되
        \item 개발할때 Design 그리고 business requirement 요구사항만 충족하면 안됩니다.
        \item 선배의 꾸지람도 많이 들었다
        \item 매일 스트래스 였다.
